...
<head>
  ...
  <title>Movies Ticket - @yield('title')</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="nav nav-pills nav-fill">
      <li class="nav-item">
        <a class="nav-link " href="{{route('movies.create')}}">Movies</a>
      </li>

      <li class="nav-item">
        <a class="nav-link " href="{{route('halls.create')}}">Cinema Halls</a>
      </li>
      
      <li class="nav-item">
        <a class="nav-link " href="{{route('showtimes.create')}}">ShowTime</a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{route('halls.index')}}">Hall List</a>
      </li>
      
      <li class="nav-item">
        <a class="nav-link" href="{{route('showtimes.index')}}">Now Showing</a>
      </li>
      <li class="nav-item">
